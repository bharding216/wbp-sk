...
<svelte:head>
	<title>Portfolio | Wendorf Beward & Partners</title>
        ...
        <div class="row mb-3 justify-content-center" data-aos="fade-up" data-aos-duration="750">
            <div class="col-12 col-md-6 align-items-center d-flex">
                <div class="text-center">
                    ...
                    <p>Through a multi-disciplinary approach and a passion for problem-solving, we have worked on projects that address critical infrastructure needs, facilitate economic growth, and enhance the quality of life for residents. From collaborating with the Port Authority of New York & New Jersey to supporting non-entitlement communities affected by hurricanes in Texas, our portfolio reflects a diverse range of experiences and successful outcomes.</p>
                    <p>Join us as we take you through the journey of these remarkable projects and demonstrate our commitment to creating lasting positive impact.</p>
                </div>
            </div>
